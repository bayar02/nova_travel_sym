...
{
 //Meriem part 
    #[Route('/newPlanning', name: 'add_planning', methods: ['GET', 'POST'])]
    public function addPlanning(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('plannings', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/plannings', name: 'plannings', methods: ['GET'])]
    public function getAllPlannigs(PlanningRepository $PlanningRepo): Response
    {
        return $this->render('Front/PlanningsList.html.twig', [
    ...
    public function eventsList(EventRepository $eventRepo): Response
    {
        return $this->render('Front/EventsList.html.twig', [
